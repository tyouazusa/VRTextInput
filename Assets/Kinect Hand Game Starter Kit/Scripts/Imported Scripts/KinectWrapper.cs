...
public class KinectWrapper
{
	...
	public static class Constants
	{
		...
		public const NuiImageResolution ImageResolutionHQ = NuiImageResolution.resolution1280x960;
	 ...
	 */
#if USE_KINECT_INTERACTION || USE_SPEECH_RECOGNITION
...
#if USE_KINECT_INTERACTION || USE_SPEECH_RECOGNITION
	[DllImport(@"KinectUnityWrapper.dll", EntryPoint = "GetSkeletonFrameHandle")]
	public static extern IntPtr GetSkeletonFrameHandle();
...
#if USE_KINECT_INTERACTION
    public static int NuiSkeletonGetNextFrame(uint dwMillisecondsToWait, ref NuiSkeletonFrame pSkeletonFrame)
	{
		IntPtr pFrame = GetSkeletonFrameHandle();
		pSkeletonFrame = (NuiSkeletonFrame)Marshal.PtrToStructure(pFrame, typeof(NuiSkeletonFrame));
